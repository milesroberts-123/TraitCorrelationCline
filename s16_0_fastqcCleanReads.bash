...
while read -u 3 -r SRA; do
	...
	fastqc -o fastqc_clean_reads -f fastq -t $SLURM_CPUS_PER_TASK $(echo $SRA)_1_trim.fastq $(echo $SRA)_2_trim.fastq
	fastqc -o fastqc_clean_reads -f fastq -t $SLURM_CPUS_PER_TASK $(echo $SRA)_trim.fastq
