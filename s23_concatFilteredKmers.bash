...
#echo Changing kmer ids...
#awk '{$1=NR}1' merged_kmers_gwas.bimbam | sed 's/^/rs/' > final_kmers_gwas.bimbam

#Extract kmer sequences
#echo Writing kmer sequences to seperate file...
#cut -d ' ' -f 1 merged_kmers_gwas.bimbam > final_kmers_gwas_seq.txt
