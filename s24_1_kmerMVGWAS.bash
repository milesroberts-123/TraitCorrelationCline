...
./gemma-0.98.4-linux-static-AMD64 -g allKmersMergedUniqueMAFfiltCat.bimbam.gz -p ./output/pheno_kmerGWAS_FT16_RGR_imputed.prdt.txt -c kmerCountCovariate.txt -k ./output/kinshipMatrix_FT16_RGR_kmers.cXX.txt -notsnp -lmm 1 -n 1 2 -o mvKmerGWASresults_FT16_RGR
